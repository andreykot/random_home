...
class Apartment:
    ...
    def create_link(self):
        ...
        for func in self.get_deal, self.get_rooms, self.get_apartment_type, self.get_price:
            query = func(query)
        return query
...
if __name__ == '__main__':
    ap = Apartment(deal=(False, False, True, False), price=(0, 49900), apartment_type=(True, False))
    link = ap.create_link()
    print(link)
